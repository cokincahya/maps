            ...
            <div class="card-body">
              ...
              <form action="/data" method="POST">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="kabupaten" id="select1" selected="true" >
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="select2" name="kecamatan" >
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="select3" name="kelurahan" >
